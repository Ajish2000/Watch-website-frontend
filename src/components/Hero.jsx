...
export default function Hero() {
  return (
    <section className="flex flex-col md:flex-row items-center justify-between p-10 h-screen w-full">
      <div>
        <h2 className=" text-4xl font-bold mb-7 mt-2">Premium Watches</h2>
        <p className="text-gray-600 mb-6"><spane className="text-xl text-gray-800 ">Elegant designs with excellent craftsmanship.</spane><br />Discover timeless craftsmanship with our premium collection of watches, where precision meets luxury. Each timepiece is meticulously designed using the finest materials, ensuring durability, style, and sophistication that lasts a lifetime. Whether for everyday elegance or special occasions, our watches reflect excellence in every detail.</p>
